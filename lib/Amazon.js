    ...
    grabProduct(body, p) {
        ...
        for (let key in scrapingResult) {
            try {
                ...
                const priceSecondOffer = $(`div[data-asin=${key}] div[data-cy="secondary-offer-recipe"] div span`)[0];
                ...
                if (priceSecondOffer && scrapingResult[key].price.current_price === 0) {
                    scrapingResult[key].price.current_price = this.geo.price_format($(priceSecondOffer).text());
                }
                ...
                if (ratingSearch) {
                    ...
                    scrapingResult[key].reviews.total_reviews = parseInt(
                        ratingSearch.parent.parent.next.next.attribs['aria-label']?.replace(/\,/g, ''),
                    );
